...
<input type="submit" value="Buscar" class="form-control btn btn-primary data">
      ...
      <h3 class="text-center"> TRANSFERÊNCIAS EMITIDAS <?php
...
$consulta = $conn->query("SELECT DISTINCT numero_cheque FROM financeiro_pagamentos_feitos  where (tipo_pagamento='Transferência') AND (SUBSTRING(mes_referencia,1,7) = '$data')");
