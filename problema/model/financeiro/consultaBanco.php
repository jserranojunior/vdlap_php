...
$consulta = $conn->query("
   SELECT  *,
   (SELECT top 1 V.favorecido from valor_contas_a_pagar AS V WHERE V.codigo = C.id)[favorecido],
   (SELECT top 1 V.inicio_mes from valor_contas_a_pagar AS V WHERE V.codigo = C.id order by inicio_mes asc)[inicio_mes], 
