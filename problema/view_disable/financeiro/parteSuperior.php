                    ...
                    <span>
                        <td>
                          ...
                          <span class="glyphicon glyphicon-piggy-bank text-success"></span><a href="" onclick="window.open('../../controller/financeiro/transferenciasemitidas/transferenciasemitidas.php', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=NO, TOP=0, LEFT=10, WIDTH=800, HEIGHT=750');"> Transferência</a><br>
                             ...
                             <span class="glyphicon glyphicon-list-alt text-warning"></span><a href="" onclick="window.open('../../controller/financeiro/faturaconsolidada/faturaconsolidada.php', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=NO, TOP=0, LEFT=0, WIDTH=1200, HEIGHT=750');"> Fatura Consolidado</a><br>
                            ...
                            <span class="glyphicon glyphicon-wrench text-primary"></span><a href="" onclick="window.open('http://192.168.0.100:89/manutencao_2/cad_orc_aprov.asp?tipo=financ', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=NO, TOP=50, LEFT=10, WIDTH=850, HEIGHT=700');"> Orçamentos aprovados</a><br>
                               <span class="glyphicon glyphicon-wrench text-primary"></span><a href="" onclick="window.open(''http://192.168.0.100:89/manutencao_2/rel_orc_aprov.asp?tipo=financ&ordem_sel=2&ano_sel=<?php echo "$ano"; ?>&mes_sel=<?php echo"$mes_atual"; ?>', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=NO, TOP=0, LEFT=10, WIDTH=850, HEIGHT=790');"> Relatório manut. Reposi.</a><br>
...
?>
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="../financeiro/contasapagar.php?mes_atual=<?php echo"$mes_atual"; ?>&ano=<?php echo"$ano"; ?>&area=&ordem=<?php echo"$ordem"; ?>">Todos</a></li>
                                    <li><a href="../financeiro/contasapagar.php?mes_atual=<?php echo"$mes_atual"; ?>&ano=<?php echo"$ano"; ?>&area=Vd Lap&ordem=<?php echo"$ordem"; ?>">Vd Lap</a></li>
                                    <li><a href="../financeiro/contasapagar.php?mes_atual=<?php echo"$mes_atual"; ?>&ano=<?php echo"$ano"; ?>&area=CMI&ordem=<?php echo"$ordem"; ?>">CMI</a></li>
                                    <li><a href="../financeiro/contasapagar.php?mes_atual=<?php echo"$mes_atual"; ?>&ano=<?php echo"$ano"; ?>&area=Geops&ordem=<?php echo"$ordem"; ?>">Geops</a></li>
                                    <li><a href="../financeiro/contasapagar.php?mes_atual=<?php echo"$mes_atual"; ?>&ano=<?php echo"$ano"; ?>&area=LS Star&ordem=<?php echo"$ordem"; ?>">LS Star</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="nav nav-tabs">
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#"><?php echo"$ordem_name"; ?>
                                    <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <li><a href="../financeiro/contasapagar.php?mes_atual=<?php echo"$mes_atual"; ?>&ano=<?php echo"$ano"; ?>&area=<?php echo"$area"; ?>&ordem=Alfabética">Alfabética</a></li>
                                    <li><a href="../financeiro/contasapagar.php?mes_atual=<?php echo"$mes_atual"; ?>&ano=<?php echo"$ano"; ?>&area=<?php echo"$area"; ?>&ordem=Cronológica">Cronológica</a></li>
                                    <li><a href="../financeiro/contasapagar.php?mes_atual=<?php echo"$mes_atual"; ?>&ano=<?php echo"$ano"; ?>&area=<?php echo"$area"; ?>&ordem=Tipo">Tipo</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
