<?php 
   ...
   */
   ...
   if(isset($_GET['diaInicial'])){
    $diaInicial = $_GET['diaInicial'];
  }elseif(isset($_GET['diaInicial']) < 1){
    $diaInicial = 01; 
  }
  else{
    $diaInicial = 01;
...
if(isset($_GET['diaFinal']) > 0){
    $diaFinal = $_GET['diaFinal'];
  }else{
    $diaFinal = date("t", strtotime($data_atual));
  };


  $ultimo_dia_mes =  date("t", strtotime($data_atual));
